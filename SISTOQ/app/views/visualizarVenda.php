        ...
        <body>
            ...
            <div class="container">
                <form>
                    ...
                    <h3 class="text-center">Visualizar Venda</h3><br>
                    <div class="row">
                        <div class="col-md-12 row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <b><label>Produto <i id="obrigatorio">*</i>:</label></b>
                                    <input class="form-control" type="text" id="nome" name="nome" placeholder="Nome do Produto" value="<?= $buscar->produto?>" required disabled>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <b><label>Quantidade <i id="obrigatorio">*</i>:</label></b>
                                    <input class="form-control" type="text" id="quantidade" name="quantidade" placeholder="Quantidade de Produto Vendido" value="<?= $buscar->quantidade?>" required disabled>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12 row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group text-right">
                                    ...
                                    <a href="listarVendas.php"><button type="button" class="btn">Voltar</button></a>
                                    <a href="alterarVenda.php?id=<?=$id?>"><button type="button" class="btn btnLaranja">Alterar</button></a>
                                </div>
                            </div>
                        </div><br>
                    </div>
            ...
            <script>
                ...
                function incrementId(id) {
                    ...
                    $("#deletar").attr('href', '../actions/deletarVenda.php?id='+id);
