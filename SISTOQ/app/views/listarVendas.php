...
<html lang="pt-br">
    ...
    <link rel="shortcut icon" href="../../public/img/logo2.png" type="image/x-icon" />
        ...
        <body>
            ...
            <!-- CONTEUDO -->
            <div class="container">
                <h3 class="text-center">Lista de Vendas</h3><br>
                <div class="row">
                        ...
                        <tbody>
                            <?php for ($i=0; $i < $quant; $i++) { ?>
                                <tr>
                                    ...
                                    <td class="text-center"><a href="visualizarVenda.php?id=<?php echo $listar[$i]->id?>"><?php echo $listar[$i]->produto?></a></td>
                                    <td class="text-center"><?php echo $listar[$i]->quantidade?></td>
                                    <td class="text-center"><a href="alterarVenda.php?id=<?php echo $listar[$i]->id?>"><button class="btn btnLaranja">Alterar</button></a> <button type="button" class="btn btn-danger" onclick="incrementId(<?php echo $listar[$i]->id?>);" data-toggle="modal" data-target="#deleteModal">Excluir</button></td>
                                </tr>
