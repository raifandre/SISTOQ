        ...
        <body>
            ...
            <div class="container">
                <form>
                    ...
                    <h3 class="text-center">Visualizar Produto</h3><br>
                    <div class="row">
                        <div class="col-md-12 row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" id="quantidade" name="quantidade" placeholder="Quantidade do Produto" value="<?= $buscar->quantidade?>" required disabled>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                        ...
                        <div class="col-md-12 row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group text-right">
                                    ...
                                    <a href="alterarProduto.php?id=<?=$id?>"><button type="button" class="btn btnLaranja">Alterar</button></a>
                                </div>
                            </div>
                        </div><br>
                    </div>
